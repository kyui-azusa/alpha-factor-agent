...
\begin{tikzpicture}[remember picture, overlay, shift={(current page.south west)}, x=1cm, y=1cm]
  ...
  \node[anchor=north west, text=ink, align=left,
    ...
    at (2.4,25.4) {结构化字段之外，\\文本还剩多少 Alpha？};
  ...
  \node[anchor=north west, text=ink, align=left,
    ...
    at (2.4,19.15) {以 A 股业绩预告为例的\\可解释因子智能体与增量检验};

  \node[anchor=north west, text=muted, align=left,
        font=\sffamily\itshape\fontsize{9.5}{13.5}\selectfont]
    at (2.4,16.1)
    {How Much Alpha Remains in Text Beyond Structured Fields?\\
     An Explainable Factor Agent and Incremental Test\\
     Using A-Share Performance Forecasts};
  ...
  \begin{scope}
    ...
    \node[anchor=north west, text=muted, opacity=0.75,
      ...
      at (2.4,7.85) {structured control · yearly rank IC};
  \end{scope}
  ...
  \node[anchor=east, text=muted, opacity=0.7,
    ...
    at (18.6,0.95) {v\PaperVersion{} · real-data final paper};
