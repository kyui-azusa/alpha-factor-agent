...
def to_report(result: dict, path: str | Path | None = None) -> Path:
    ...
    payload = {
        ...
        "experiment_lock": _public_json(result.get("experiment_lock", {})),
        "field_lineage": _public_json(result.get("field_lineage", {})),
        "audit": _public_json(result.get("audit", {})),
        ...
        "feedback_audit": _public_json(result.get("feedback_audit", {})),
        "oos_evidence": _public_json(result.get("oos_evidence", {})),
